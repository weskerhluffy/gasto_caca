...
INSERT INTO `aplicacion_periodicas` VALUES (1,3,800,'pago mensual lavadora','2013-07-03 08:47:29','2013-07-03 08:47:29','1'),(3,3,4100,'renta','2013-07-03 08:50:05','2013-07-19 01:53:41','');
...
INSERT INTO `deudas` VALUES (1,6400,'2013-07-03 03:39:00','lavadora',1,'2013-07-03 08:40:13','2013-07-19 01:47:23');
...
--
-- Temporary table structure for view `restante_deudas`
--

DROP TABLE IF EXISTS `restante_deudas`;
/*!50001 DROP VIEW IF EXISTS `restante_deudas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `restante_deudas` (
  `id` tinyint NOT NULL,
  `monto` tinyint NOT NULL,
  `contraido` tinyint NOT NULL,
  `descripcion` tinyint NOT NULL,
  `credito_id` tinyint NOT NULL,
  `created_at` tinyint NOT NULL,
  `updated_at` tinyint NOT NULL,
  `restante` tinyint NOT NULL
) ENGINE=MyISAM */;
...
--
-- Final view structure for view `restante_deudas`
--

/*!50001 DROP TABLE IF EXISTS `restante_deudas`*/;
/*!50001 DROP VIEW IF EXISTS `restante_deudas`*/;
...
/*!50013 DEFINER=`ernesto`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `restante_deudas` AS select `d`.`id` AS `id`,`d`.`monto` AS `monto`,`d`.`contraido` AS `contraido`,`d`.`descripcion` AS `descripcion`,`d`.`credito_id` AS `credito_id`,`d`.`created_at` AS `created_at`,`d`.`updated_at` AS `updated_at`,(`d`.`monto` - (select sum(`e`.`monto`) from (`egresos` `e` join `deudas_egresos` `de` on((`e`.`id` = `de`.`egreso_id`))) where (`de`.`deuda_id` = `d`.`id`))) AS `restante` from `deudas` `d` */;
...
-- Dump completed on 2013-07-18 22:17:19
